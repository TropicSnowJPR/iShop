...
public enum Messages {
	...
	SHOP_NOT_COOWNER("shopNotCoOwner"),
	SHOP_NOT_MANAGER("shopNotManager"),
	SHOP_NOT_MEMBER("shopNotMember"),
	SHOP_NOT_OWNER("shopNotOwner"),
	SHOP_NUMBER("shopNumber"),
	SHOP_OUT("outOfStock"),
	SHOP_ADDOWNER_USAGE("shopAddOwnerUsage"),
	SHOP_ADDOWNER("shopAddOwner"),
	SHOP_ADDOWNER_TARGET("shopAddOwnerTarget"),
	SHOP_REMOVEOWNER_USAGE("shopRemoveOwnerUsage"),
	SHOP_REMOVEOWNER("shopRemoveOwner"),
	SHOP_ADDMANAGER_USAGE("shopAddManagerUsage"),
	SHOP_ADDMANAGER("shopAddManager"),
	SHOP_ADDMANAGER_TARGET("shopAddManagerTarget"),
	SHOP_REMOVEMANAGER_USAGE("shopRemoveManagerUsage"),
	SHOP_REMOVEMANAGER("shopRemoveManager"),
	SHOP_MEMBERS_USAGE("shopMembersUsage"),
	SHOP_MEMBERSLIST("shopMembersList"),
	SHOP_MEMBERS_OWNER("shopMembersOwner"),
	SHOP_MEMBERS_COOWNERS("shopMembersCoOwners"),
	SHOP_MEMBERS_MANAGERS("shopMembersManagers"),
	SHOP_ALREADY_MEMBER("shopAlreadyMember"),
	SHOP_MANAGER_STOCK_ONLY("shopManagerStockOnly"),
	SHOP_LEFT("shopLeft"),
	SHOP_LEAVE_USAGE("shopLeaveUsage"),
	SHOP_CANNOT_LEAVE_OWNER("shopCannotLeaveOwner"),
	SHOP_PAGE("page"),
